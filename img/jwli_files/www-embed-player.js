...
function Ga(a){if(!Ia.test(a))return a;-1!=a.indexOf("&")&&(a=a.replace(Ja,"&amp;"));-1!=a.indexOf("<")&&(a=a.replace(Ka,"&lt;"));-1!=a.indexOf(">")&&(a=a.replace(La,"&gt;"));-1!=a.indexOf('"')&&(a=a.replace(Ma,"&quot;"));-1!=a.indexOf("'")&&(a=a.replace(Na,"&#39;"));-1!=a.indexOf("\x00")&&(a=a.replace(Oa,"&#0;"));return a}
...
oa(nf);nf.getInstance();var pf=[],qf=!1;function rf(){if("1"!=Wa(ee(),"args","privembed")){var a=function(){qf=!0;"google_ad_status"in window?P("DCLKSTAT",1):P("DCLKSTAT",2)};
...
;function kg(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=Id(J(window.location.href)[3]||null);f&&e.push(f);f=Id(J(d)[3]||null);if(0<=ya(e,f)||!f&&0==d.lastIndexOf("/",0))if(S("autoescape_tempdata_url")&&(e=document.createElement("a"),Cb(e,d),d=e.href),d){f=J(d);d=f[5];e=f[6];f=f[7];var g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e)){if(b.itct||b.ved)b.csn=b.csn||
...
;function lg(a,b,c){mg({attachChild:{csn:a,parentVisualElement:gg(b),visualElements:[gg(c)]}})}
function mg(a){var b=Tf;a.eventTimeMs=Math.round(O());a.lactMs=Ef();Nf({endpoint:"log_interaction",payload:a},b)}
;function ng(a){a=a||{};this.url=a.url||"";this.args=a.args||ab(og);this.assets=a.assets||{};this.attrs=a.attrs||ab(pg);this.params=a.params||ab(qg);this.minVersion=a.min_version||"8.0.0";this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
var og={enablejsapi:1},pg={},qg={allowscriptaccess:"always",allowfullscreen:"true",bgcolor:"#000000"};function rg(a){var b=new ng,c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];b[c]="object"==pa(d)?ab(d):d}return b}
;function sg(){G.call(this);this.b=[]}
n(sg,G);sg.prototype.m=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.fb)}G.prototype.m.call(this)};var tg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function ug(a){a=a||"";if(window.spf){var b=a.match(tg);spf.style.load(a,b?b[1]:"",void 0)}else vg(a)}
function vg(a){var b=wg(a),c=document.getElementById(b),d=c&&ie(c,"loaded");d||c&&!d||(c=xg(a,b,function(){ie(c,"loaded")||(ge(c),se(b),T(y(te,b),0))}))}
...
function wg(a){var b=document.createElement("A");a=yb(a);Cb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Pa(b)}
;var yg=v("ytLoggingLatencyUsageStats_")||{};t("ytLoggingLatencyUsageStats_",yg,void 0);var zg=0;function Ag(a){yg[a]=yg[a]||{count:0};var b=yg[a];b.count++;b.time=O();zg||(zg=kf(Bg,5E3));return 10<b.count?(11==b.count&&ff(Error("CSI data exceeded logging limit with key: "+a),0==a.indexOf("info")?"WARNING":"ERROR"),!0):!1}
function Bg(){var a=O(),b;for(b in yg)6E4<a-yg[b].time&&delete yg[b];zg=0}
;function Cg(a,b){this.version=a;this.args=b}
;function Dg(a){this.topic=a}
Dg.prototype.toString=function(){return this.topic};var Eg=v("ytPubsub2Pubsub2Instance")||new I;I.prototype.subscribe=I.prototype.subscribe;I.prototype.unsubscribeByKey=I.prototype.L;I.prototype.publish=I.prototype.J;I.prototype.clear=I.prototype.clear;t("ytPubsub2Pubsub2Instance",Eg,void 0);t("ytPubsub2Pubsub2SubscribedKeys",v("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);t("ytPubsub2Pubsub2TopicToKeys",v("ytPubsub2Pubsub2TopicToKeys")||{},void 0);t("ytPubsub2Pubsub2IsAsync",v("ytPubsub2Pubsub2IsAsync")||{},void 0);
t("ytPubsub2Pubsub2SkipSubKey",null,void 0);function Fg(a,b){var c=v("ytPubsub2Pubsub2Instance");c&&c.publish.call(c,a.toString(),a,b)}
;var Y=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function Gg(){var a=Q("TIMING_TICK_EXPIRATION");a||(a={},P("TIMING_TICK_EXPIRATION",a));return a}
function Hg(){var a=Gg(),b;for(b in a)of(a[b]);P("TIMING_TICK_EXPIRATION",{})}
;function Ig(a,b){Cg.call(this,1,arguments)}
n(Ig,Cg);function Jg(a,b){Cg.call(this,1,arguments)}
n(Jg,Cg);var Kg=new Dg("aft-recorded"),Lg=new Dg("timing-sent");var Mg={vc:!0},Ng={ad_allowed:"adTypesAllowed",ad_at:"adType",ad_cpn:"adClientPlaybackNonce",ad_docid:"adVideoId",yt_ad_an:"adNetworks",p:"httpProtocol",t:"transportProtocol",cpn:"clientPlaybackNonce",csn:"clientScreenNonce",docid:"videoId",is_nav:"isNavigation",yt_lt:"loadType",yt_ad:"isMonetized",nr:"webInfo.navigationReason",ncnp:"webInfo.nonPreloadedNodeCount",paused:"playerInfo.isPausedOnLoad",fmt:"playerInfo.itag",yt_pl:"watchInfo.isPlaylist",yt_ad_pr:"prerollAllowed",yt_red:"isRedSubscriber",
st:"serverTimeMs",vph:"viewportHeight",vpw:"viewportWidth",yt_vis:"isVisible"},Qg="ap c cver ei srt yt_fss yt_li plid vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),Rg="isNavigation isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber isVisible watchInfo.isPlaylist".split(" "),
Sg=!1;
function Tg(a){if("_"!=a[0]){var b=a;Y.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),Y.mark(b))}b=Ug();var c=O();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=Gg();if(c=b[a])of(c),b[a]=0;Vg()["tick_"+a]=void 0;O();Wg()?(b=Xg(),"_start"==a?Ag("baseline_"+b)||Sf("latencyActionBaselined",{clientActionNonce:b},void 0,void 0):Ag("tick_"+a+"_"+b)||Sf("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0,void 0),a=!0):a=!1;if(a=!a)a=!v("yt.timing.pingSent_");if(a&&(b=de("TIMING_ACTION"),a=
Ug(),v("ytglobal.timingready_")&&b&&a._start&&(b=Yg()))){S("tighter_critical_section")&&!Sg&&(Fg(Kg,new Ig(Math.round(b-a._start),void 0)),Sg=!0);b=!0;c=Q("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Zg()}}
function $g(){var a=ah().info.yt_lt="hot_bg";Vg().info_yt_lt=a;if(Wg())if("yt_lt"in Ng){var b=Ng.yt_lt;0<=ya(Rg,b)&&(a=!!a);if(Wg()){var c={};b=b.split(".");for(var d=c,e=0;e<b.length-1;e++)d[b[e]]=d[b[e]]||{},d=d[b[e]];d[b[b.length-1]]=a;a=Xg();b=Object.keys(c).join("");Ag("info_"+b+"_"+a)||(c.clientActionNonce=a,Sf("latencyActionInfo",c,void 0,void 0))}}else 0<=ya(Qg,"yt_lt")||R(Error("Unknown label yt_lt logged with GEL CSI."))}
function Yg(){var a=Ug();if(a.aft)return a.aft;for(var b=Q("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function Zg(){Hg();if(!Wg()){var a=Ug(),b=ah().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&w(a[d])){var e=d.slice(1);if(e in Mg){var f=Aa(a[d],function(a){return Math.round(a-c)});
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=v("ytglobal.timingReportbuilder_")){if(f=f(a,b,void 0))bh(f,e),ch(),dh(),eh(!1,void 0),Q("TIMING_ACTION")&&P("PREVIOUS_ACTION",Q("TIMING_ACTION")),P("TIMING_ACTION","")}else{var g=Q("CSI_SERVICE_NAME","youtube");f={v:2,s:g,action:Q("TIMING_ACTION",void 0)};var h=b.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var k=window.location.protocol+v("ytplayer.config.assets.js");(k=Y.getEntriesByName?Y.getEntriesByName(k)[0]:null)?b.h5jse=Math.round(b.h5jse-k.responseEnd):
delete b.h5jse}a.aft=Yg();fh()&&"youtube"==g&&($g(),g=a.vc,k=a.pbs,delete a.aft,b.aft=Math.round(k-g));for(var m in b)"_"!=m.charAt(0)&&(f[m]=b[m]);a.ps=O();b={};m=[];for(d in a)"_"!=d.charAt(0)&&(g=Math.round(a[d]-c),b[d]=g,m.push(d+"."+g));f.rt=m.join(",");(a=v("ytdebug.logTiming"))&&a(f,b);bh(f,e,void 0);Fg(Lg,new Jg(b.aft+(h||0),void 0))}}}
var dh=x(Y.clearResourceTimings||Y.webkitClearResourceTimings||Y.mozClearResourceTimings||Y.msClearResourceTimings||Y.oClearResourceTimings||na,Y);
function bh(a,b,c){if(S("debug_csi_data")){var d=v("yt.timing.csiData");d||(d=[],t("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var f=void 0===f?"":f;try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,f)||bf(a,void 0,void 0,void 0,f)}catch(g){bf(a,void 0,void 0,void 0,f)}}else bf(a);eh(!0,c)}
function Xg(){var a=ah().nonce;a||(a=dg(),ah().nonce=a);return a}
function Ug(){return ah().tick}
function Vg(){var a=ah();"gel"in a||(a.gel={});return a.gel}
function ah(){return v("ytcsi.data_")||ch()}
function ch(){var a={tick:{},info:{}};t("ytcsi.data_",a,void 0);return a}
function eh(a,b){t("yt.timing."+(b||"")+"pingSent_",a,void 0)}
function fh(){var a=Ug(),b=a.pbr,c=a.vc;a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==ah().info.yt_pvis}
function Wg(){return!!S("csi_on_gel")}
;function gh(a,b){G.call(this);this.l=this.T=a;this.H=b;this.o=!1;this.f={};this.R=this.G=null;this.w=new I;uc(this,y(vc,this.w));this.i={};this.O=this.S=this.g=this.Y=this.b=null;this.N=!1;this.j=this.D=null;this.U={};this.ua=["onReady"];this.X=null;this.ka=NaN;this.P={};hh(this);this.V("WATCH_LATER_VIDEO_ADDED",this.La.bind(this));this.V("WATCH_LATER_VIDEO_REMOVED",this.Ma.bind(this));this.V("onAdAnnounce",this.ya.bind(this));this.va=new sg(this);uc(this,y(vc,this.va))}
n(gh,G);l=gh.prototype;
l.ha=function(a){if(!this.h){a instanceof ng||(a=new ng(a));this.Y=a;this.b=rg(a);this.g=this.b.attrs.id||this.g;"video-player"==this.g&&(this.g=this.H,this.b.attrs.id=this.H);this.l.id==this.g&&(this.g+="-player",this.b.attrs.id=this.g);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.H;this.S||(this.S=ih(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.l.style.width=Tb(Number(a)||a);if(a=this.b.attrs.height)this.l.style.height=Tb(Number(a)||
a);jh(this);this.o&&kh(this)}};
l.Ba=function(){return this.Y};
function kh(a){a.b.loaded||(a.b.loaded=!0,"0"!=a.b.args.autoplay?a.f.loadVideoByPlayerVars(a.b.args):a.f.cueVideoByPlayerVars(a.b.args))}
function lh(a){var b=!0,c=mh(a);c&&a.b&&(a=a.b,b=ie(c,"version")==a.assets.js);return b&&!!v("yt.player.Application.create")}
function jh(a){if(!a.h&&!a.N){var b=lh(a);if(b&&"html5"==(mh(a)?"html5":null))a.O="html5",a.o||nh(a);else if(oh(a),a.O="html5",b&&a.j)a.T.appendChild(a.j),nh(a);else{a.b.loaded=!0;var c=!1;a.D=function(){c=!0;var b=rg(a.b);v("yt.player.Application.create")(a.T,b);nh(a)};
a.N=!0;b?a.D():(xe(a.b.assets.js,a.D),ug(a.b.assets.css),ph(a)&&!c&&t("yt.player.Application.create",null,void 0))}}}
function mh(a){var b=Hb(a.g);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.g));return b}
function nh(a){if(!a.h){var b=mh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.N=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||qh(a)):a.ka=T(function(){nh(a)},50)}}
function qh(a){hh(a);a.o=!0;var b=mh(a);b.addEventListener&&(a.G=rh(a,b,"addEventListener"));b.removeEventListener&&(a.R=rh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.f[e]||(a.f[e]=rh(a,b,e))}for(var f in a.i)a.G(f,a.i[f]);kh(a);a.S&&a.S(a.f);a.w.J("onReady",a.f)}
function rh(a,b,c){var d=b[c];return function(){try{return a.X=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.X=e,R(e,"WARNING",void 0,void 0,void 0))}}}
function hh(a){a.o=!1;if(a.R)for(var b in a.i)a.R(b,a.i[b]);for(var c in a.P)ke(parseInt(c,10));a.P={};a.G=null;a.R=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=a.V.bind(a);a.f.removeEventListener=a.Sa.bind(a);a.f.destroy=a.dispose.bind(a);a.f.getLastError=a.Ca.bind(a);a.f.getPlayerType=a.Da.bind(a);a.f.getCurrentVideoConfig=a.Ba.bind(a);a.f.loadNewVideoConfig=a.ha.bind(a);a.f.isReady=a.Ka.bind(a)}
l.Ka=function(){return this.o};
l.V=function(a,b){var c=this,d=ih(this,b);if(d){if(!(0<=ya(this.ua,a)||this.i[a])){var e=sh(this,a);this.G&&this.G(a,e)}this.w.subscribe(a,d);"onReady"==a&&this.o&&T(function(){d(c.f)},0)}};
l.Sa=function(a,b){if(!this.h){var c=ih(this,b);c&&md(this.w,a,c)}};
function ih(a,b){var c=b;if("string"==typeof b){if(a.U[b])return a.U[b];c=function(){var a=v(b);a&&a.apply(p,arguments)};
a.U[b]=c}return c?c:null}
function sh(a,b){var c="ytPlayer"+b+a.H;a.i[b]=c;p[c]=function(c){var d=a.b&&a.b.args&&a.b.args.fflags;if(d&&0>d.indexOf("use_html5_player_event_timeout=true"))a.w.J(b,c);else{var f=T(function(){if(!a.h){a.w.J(b,c);var d=a.P,e=String(f);e in d&&delete d[e]}},0);
$a(a.P,String(f))}};
return c}
...
l.Da=function(){return this.O||(mh(this)?"html5":null)};
l.Ca=function(){return this.X};
function oh(a){Tg("dcp");a.cancel();hh(a);a.O=null;a.b&&(a.b.loaded=!1);var b=mh(a);b&&(lh(a)||!ph(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.T;b=a.firstChild;)a.removeChild(b)}
l.cancel=function(){this.D&&De(this.b.assets.js,this.D);ke(this.ka);this.N=!1};
l.m=function(){oh(this);if(this.j&&this.b&&this.j.destroy)try{this.j.destroy()}catch(b){R(Error("Error destroying player: "+b))}this.U=null;for(var a in this.i)p[this.i[a]]=null;this.Y=this.b=this.f=null;delete this.T;delete this.l;G.prototype.m.call(this)};
function ph(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var th={},uh="player_uid_"+(1E9*Math.random()>>>0);function vh(a){var b="player";b=r(b)?Hb(b):b;var c=uh+"_"+(b[ta]||(b[ta]=++ua)),d=th[c];if(d)return d.ha(a),d.f;d=new gh(b,c);th[c]=d;se("player-added",d.f);uc(d,y(wh,d));T(function(){d.ha(a)},0);
return d.f}
function wh(a){delete th[a.H]}
;function xh(){var a=yh(),b=zh();if(!a&&!b||!window.JSON)return null;try{var c=a.get("yt-player-two-stage-token")}catch(d){}if(!r(c))try{c=b.get("yt-player-two-stage-token")}catch(d){}if(!r(c))return null;try{c=JSON.parse(c,void 0)}catch(d){}return c}
var zh=Nb(function(){var a=new xd;return a.isAvailable()?new td(a):null}),yh=Nb(function(){var a=new yd;
return a.isAvailable()?new td(a):null});function Ah(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
...
function Ch(a,b,c){if(sa(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function Dh(a,b,c,d){if(sa(a)&&!w(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};r(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
function Eh(a){var b=a.video_id||a.videoId;if(r(b)){var c=xh()||{},d=xh()||{};q(void 0)?d[b]=void 0:delete d[b];var e=z()+3E5,f=zh();if(f&&window.JSON){r(d)||(d=JSON.stringify(d,void 0));try{f.set("yt-player-two-stage-token",d,e)}catch(g){f.remove("yt-player-two-stage-token")}}(b=c[b])&&(a.two_stage_token=b)}}
;function Fh(a){G.call(this);this.b=a;this.b.subscribe("command",this.ra,this);this.f={};this.i=!1}
...
l.Ua=function(a,b){this.i&&!this.h&&Gh(this.b,a,this.ba(a,b))};
l.ba=function(a,b){if(null!=b)return{value:b}};
function Hh(a,b){b in a.f&&(a.removeEventListener(b,a.f[b]),delete a.f[b])}
l.m=function(){var a=this.b;a.h||md(a.b,"command",this.ra,this);this.b=null;for(var b in this.f)Hh(this,b);Fh.u.m.call(this)};function Kh(a,b){Fh.call(this,b);this.g=a;this.start()}
...
Kh.prototype.m=function(){Kh.u.m.call(this);delete this.g};function Lh(a,b,c,d){G.call(this);this.f=b||null;this.o="*";this.g=c||null;this.sessionId=null;this.channel=d||null;this.D=!!a;this.l=x(this.w,this);window.addEventListener("message",this.l)}
...
Lh.prototype.sendMessage=function(a,b){var c=b||this.f;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=Jc(a);c.postMessage(d,this.o)}catch(e){R(e,"WARNING")}}};
Lh.prototype.m=function(){window.removeEventListener("message",this.l);G.prototype.m.call(this)};function Mh(a,b,c){Lh.call(this,a,b,c||Q("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.j=this.b=this.i=null}
n(Mh,Lh);function Nh(){var a=this.f=new Mh(!!Q("WIDGET_ID_ENFORCE")),b=x(this.Oa,this);a.i=b;a.j=null;this.f.channel="widget";if(a=Q("WIDGET_ID"))this.f.sessionId=a;this.g=[];this.j=!1;this.i={}}
l=Nh.prototype;l.Oa=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.i[a]||"onReady"==a||(this.addEventListener(a,Oh(this,a)),this.i[a]=!0)):this.ta(a,b,c)};
l.ta=function(){};
...
l.dispose=function(){this.f=null};function Qh(a){Nh.call(this);this.b=a;this.h=[];this.addEventListener("onReady",x(this.Na,this));this.addEventListener("onVideoProgress",x(this.Ya,this));this.addEventListener("onVolumeChange",x(this.Za,this));this.addEventListener("onApiChange",x(this.Ta,this));this.addEventListener("onPlaybackQualityChange",x(this.Va,this));this.addEventListener("onPlaybackRateChange",x(this.Wa,this));this.addEventListener("onStateChange",x(this.Xa,this));this.addEventListener("onWebglSettingsChanged",x(this.ab,
this))}
A(Qh,Nh);l=Qh.prototype;l.ta=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&Ah(a)){var d=b;if(sa(d[0])&&!w(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Ch.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Bh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Dh.apply(window,d)}d=e}Eh(d);b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);Ah(a)&&Ph(this,this.ca())}};
...
l.Va=function(a){Ph(this,{playbackQuality:a})};
l.Wa=function(a){Ph(this,{playbackRate:a})};
...
l.Za=function(){Ph(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
l.Ya=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:z()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());Ph(this,a)};
l.ab=function(){if(this.b.getSphericalProperties){var a={SphericalProperties:this.b.getSphericalProperties()};Ph(this,a)}};
l.dispose=function(){Qh.u.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.b.removeEventListener(b.eventType,b.listener)}this.h=[]};function Rh(){G.call(this);this.b=new I;uc(this,y(vc,this.b))}
A(Rh,G);Rh.prototype.subscribe=function(a,b,c){return this.h?0:this.b.subscribe(a,b,c)};
Rh.prototype.j=function(a,b){this.h||this.b.J.apply(this.b,arguments)};function Sh(a,b,c){Rh.call(this);this.f=a;this.g=b;this.i=c}
A(Sh,Rh);function Gh(a,b,c){if(!a.h){var d=a.f;d.h||a.g!=d.b||(a={id:a.i,command:b},c&&(a.data=c),d.b.postMessage(Jc(a),d.g))}}
Sh.prototype.m=function(){this.g=this.f=null;Sh.u.m.call(this)};function Th(a,b,c){G.call(this);this.b=a;this.g=c;this.i=U(window,"message",x(this.j,this));this.f=new Sh(this,a,b);uc(this,y(vc,this.f))}
...
Th.prototype.m=function(){zf(this.i);this.b=null;Th.u.m.call(this)};function Uh(){var a=Wa(window,"settings","experiments","flags","html5_serverside_pagead_id_sets_cookie")||Q("EXP_HTML5_SERVERSIDE_PAGEAD_ID_SETS_COOKIE",!1)||S("html5_serverside_pagead_id_sets_cookie")?"//googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//googleads.g.doubleclick.net/pagead/id",b=ab(Vh);return new H(function(c,d){b.A=function(a){Le(a)?c(a):d(new Wh("Request failed, status="+a.status,"net.badstatus",a))};
b.onError=function(a){d(new Wh("Unknown request error","net.unknown",a))};
b.M=function(a){d(new Wh("Request timed out","net.timeout",a))};
Te(a,b)})}
...
Xh.prototype.then=function(a,b,c){return this.h?this.h.then(a,b,c):1===this.f&&a?(a=a.call(c,this.b),Qc(a)?a:Yh(a)):2===this.f&&b?(a=b.call(c,this.b),Qc(a)?a:Zh(a)):this};
Xh.prototype.getValue=function(){return this.b};
Pc(Xh);function Zh(a){var b=new Xh;a=void 0===a?null:a;b.f=2;b.b=void 0===a?null:a;return b}
function Yh(a){var b=new Xh;a=void 0===a?null:a;b.f=1;b.b=void 0===a?null:a;return b}
;function $h(a){B.call(this,a.message||a.description||a.name);this.isMissing=a instanceof ai;this.isTimeout=a instanceof Wh&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof dd}
n($h,B);$h.prototype.name="BiscottiError";function ai(){B.call(this,"Biscotti ID is missing from server")}
n(ai,B);ai.prototype.name="BiscottiMissingError";var Vh={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},bi=null;function ci(){if("1"===Wa(ee(),"args","privembed"))return Vc(Error("Biscotti ID is not available in private embed mode"));bi||(bi=cd(Uh().then(di),function(a){return ei(2,a)}));
return bi}
function di(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new ai;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new ai;a=a.id;fi(a);bi=Yh(a);gi(18E5,2);return a}
function ei(a,b){var c=new $h(b);fi("");bi=Zh(c);0<a&&gi(12E4,a-1);throw c;}
function gi(a,b){T(function(){cd(Uh().then(di,function(a){return ei(b,a)}),na)},a)}
function fi(a){t("yt.ads.biscotti.lastId_",a,void 0)}
function hi(){try{var a=v("yt.ads.biscotti.getId_");return a?a():ci()}catch(b){return Vc(b)}}
;function ii(a){B.apply(this,arguments)}
n(ii,B);ii.prototype.name="YuzuError";function ji(){var a=new ii("ID is missing"),b=new ii("Timeout"),c=null,d=!1;ae(function(){c=Zd();d=!0});
if(d)return c?Yh(c):Zh(a);var e=new H(function(b,c){ae(function(){var d=Zd();d?b(d):c(a)})}),f=Gd().then(function(){return Vc(b)});
return ad(Yc([e,f]),function(){return f.cancel()})}
;function ki(a){if("1"!==Wa(ee(),"args","privembed")){a&&(v("yt.ads.biscotti.getId_")||xa("yt.ads.biscotti.getId_",ci));try{var b=hi();if(S("enable_yuzu")){v("yt.ads.yuzu.getId_")||t("yt.ads.yuzu.getId_",ji,void 0);try{var c=v("yt.ads.yuzu.getId_")()}catch(d){c=Vc(d)}}else c=Vc(new ii("unimplemented"));Zc([b,c]).then(function(a){var b=a[0];a=a[1];if(b.Z||a.Z){b=b.value;a=a.value;var c={};c.dt=Ub;c.flash=Qd||"0";a:{try{var d=window.top.location.href}catch(Va){d=2;break a}d=null!=d?d==window.document.location.href?
0:1:2}d=(c.frm=d,c);d.u_tz=-(new Date).getTimezoneOffset();var h=void 0===h?F:h;try{var k=h.history.length}catch(Va){k=0}d.u_his=k;d.u_java=!!F.navigator&&"unknown"!==typeof F.navigator.javaEnabled&&!!F.navigator.javaEnabled&&F.navigator.javaEnabled();F.screen&&(d.u_h=F.screen.height,d.u_w=F.screen.width,d.u_ah=F.screen.availHeight,d.u_aw=F.screen.availWidth,d.u_cd=F.screen.colorDepth);F.navigator&&F.navigator.plugins&&(d.u_nplug=F.navigator.plugins.length);F.navigator&&F.navigator.mimeTypes&&(d.u_nmime=
F.navigator.mimeTypes.length);d.ca_type=Pd?"flash":"image";if(S("enable_server_side_search_pyv")||S("enable_server_side_mweb_search_pyv")){k=window;try{var m=k.screenX;var u=k.screenY}catch(Va){}try{var M=k.outerWidth;var aa=k.outerHeight}catch(Va){}try{var Og=k.innerWidth;var Pg=k.innerHeight}catch(Va){}m=[k.screenLeft,k.screenTop,m,u,k.screen?k.screen.availWidth:void 0,k.screen?k.screen.availTop:void 0,M,aa,Og,Pg];u=window.top;try{var V=(u||window).document,Ua="CSS1Compat"==V.compatMode?V.documentElement:
V.body;var Ha=(new Gb(Ua.clientWidth,Ua.clientHeight)).round()}catch(Va){Ha=new Gb(-12245933,-12245933)}V={};Ua=0;p.SVGElement&&p.document.createElementNS&&(Ua|=1);V.bc=Ua;V.bih=Ha.height;V.biw=Ha.width;V.brdim=m.join();Ha=(V.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Sb.visibilityState||Sb.webkitVisibilityState||Sb.mozVisibilityState||""]||0,V.wgl=!!F.WebGLRenderingContext,V);for(var Rd in Ha)d[Rd]=Ha[Rd]}void 0!==b&&(d.bid=b);void 0!==a&&(d.anid=a);d.bsq=li++;Ze("//www.youtube.com/ad_data_204",
{Ea:!1,B:d})}});
T(ki,18E5)}catch(d){R(d)}}}
var li=0;var Z=v("ytglobal.prefsUserPrefsPrefs_")||{};t("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function mi(){this.b=Q("ALT_PREF_COOKIE_NAME","PREF");var a=$b.get(""+this.b,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
l=mi.prototype;l.get=function(a,b){ni(a);oi(a);var c=void 0!==Z[a]?Z[a].toString():null;return null!=c?c:b?b:""};
l.set=function(a,b){ni(a);oi(a);if(null==b)throw Error("ExpectedNotNull");Z[a]=b.toString()};
l.remove=function(a){ni(a);oi(a);delete Z[a]};
...
function oi(a){if(/^f([1-9][0-9]*)$/.test(a))throw Error("ExpectedRegexMatch: "+a);}
function ni(a){if(!/^\w+$/.test(a))throw Error("ExpectedRegexMismatch: "+a);}
function pi(a){a=void 0!==Z[a]?Z[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
oa(mi);var qi=null,ri=null,si=null,ti={};function ui(a){Sf(a.payload_name,a.payload,void 0,void 0)}
function vi(a){var b=a.id;a=a.ve_type;var c=hg++;a=new fg(void 0,a,c,void 0,void 0);ti[b]=a;b=jg();c=ig();b&&c&&lg(b,c,a)}
function wi(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(P("client-screen-nonce",b),P("ROOT_VE_TYPE",a),b&&Sf("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:eg,clientScreenNonce:b}),a=ig()))for(var c in ti){var d=ti[c];d&&lg(b,a,d)}}
function xi(a){ti[a.id]=new fg(a.tracking_params)}
function yi(a){var b=jg();a=ti[a.id];b&&a&&(S("interaction_click_on_gel_web")?Sf("visualElementGestured",{csn:b,ve:gg(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"}):mg({click:{csn:b,visualElement:gg(a)}}))}
function zi(a){a=a.ids;var b=jg();if(b)for(var c=0;c<a.length;c++){var d=ti[a[c]];d&&Sf("visualElementShown",{csn:b,ve:gg(d),eventType:1})}}
function Ai(){var a=qi;a&&a.startInteractionLogging&&a.startInteractionLogging()}
...
t("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);ki(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=Q("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);Q("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&Eh(a.args);qi=a=vh(a);a.addEventListener("onScreenChanged",wi);a.addEventListener("onLogClientVeCreated",vi);a.addEventListener("onLogServerVeCreated",xi);a.addEventListener("onLogToGel",ui);
a.addEventListener("onLogVeClicked",yi);a.addEventListener("onLogVesShown",zi);a.addEventListener("onReady",Ai);b=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?si=new Qh(a):Q("ENABLE_POST_API")&&r(b)&&r(c)&&(ri=new Th(window.parent,b,c),si=new Kh(a,ri.f));Q("BG_P")&&(Q("BG_I")||Q("BG_IU"))&&Fe();rf()},void 0);
t("yt.www.watch.ads.restrictioncookie.spr",function(a){bf(a+"mac_204?action_fcts=1");return!0},void 0);
var Bi=fe(function(){Tg("ol");var a=mi.getInstance(),b=!!((pi("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&yc(document.body,"exp-invert-logo"))if(c&&!yc(document.body,"inverted-hdpi")){var d=document.body;d.classList?d.classList.add("inverted-hdpi"):yc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")}else!c&&yc(document.body,"inverted-hdpi")&&zc();b!=c&&(b="f"+(Math.floor(119/31)+1),d=pi(b)||0,d=c?d|67108864:d&-67108865,
0==d?delete Z[b]:Z[b]=d.toString(16).toString(),a.save())}),Ci=fe(function(){var a=qi;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&(Ee=null);a=0;for(var b=pf.length;a<b;a++)of(pf[a]);pf.length=0;Ce("//static.doubleclick.net/instream/ad_status.js");qf=!1;P("DCLKSTAT",0);wc(si,ri);if(a=qi)a.removeEventListener("onScreenChanged",wi),a.removeEventListener("onLogClientVeCreated",vi),a.removeEventListener("onLogServerVeCreated",xi),a.removeEventListener("onLogToGel",ui),a.removeEventListener("onLogVeClicked",yi),a.removeEventListener("onLogVesShown",zi),a.removeEventListener("onReady",
Ai),a.destroy();ti={}});
window.addEventListener?(window.addEventListener("load",Bi),window.addEventListener("unload",Ci)):window.attachEvent&&(window.attachEvent("onload",Bi),window.attachEvent("onunload",Ci));xa("yt.abuse.botguardInitialized",v("yt.abuse.botguardInitialized")||He);xa("yt.abuse.invokeBotguard",v("yt.abuse.invokeBotguard")||Ie);xa("yt.abuse.dclkstatus.checkDclkStatus",v("yt.abuse.dclkstatus.checkDclkStatus")||sf);xa("yt.player.exports.navigate",v("yt.player.exports.navigate")||kg);
